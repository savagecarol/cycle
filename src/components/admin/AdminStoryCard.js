  ...
  return (
        ...
        <div class="relative isolate flex flex-col  overflow-hidden rounded-lg px-4 py-4  max-w-sm mx-auto mt-8 min-h-96 min-w-64"> 
            <img src="https://dummyimage.com/420x260" alt="University of Southern California" class="absolute inset-0 h-full w-full object-cover"/>
                ...
                <div class="py-3 sm:py-4 z-10  ">
                    <div class="flex items-center ">
                        <div class="flex-shrink-0">
                            <img class="w-8 h-8 rounded-full" src= "https://img.freepik.com/premium-vector/account-icon-user-icon-vector-graphics_292645-552.jpg" alt="Lana image" />
                        </div>
                ...
                <div class="absolute bottom-0 left-0  right z-10 mb-4 ml-4 px-4 py-2 text-white text-sm bg-green-500 rounded-lg shadow-md">Accept </div>
                <div class="absolute bottom-0 left-1/3 right-1/3  right z-10 mb-4 mr-8  px-6 py-2 text-white text-sm bg-red-500 rounded-lg shadow-md">Reject </div> 
