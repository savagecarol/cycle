    ...
    <div>
        ...
        <div className='mx-16 my-12'>
            ...
            <div class = "w-1/2 p-12 bg-gray-300 hover:bg-gray-500 rounded-lg mx-6 flex flex-col items-center justify-center">
                    ...
                    <h1 class="text-base title-font text-gray-900 ">Add Ride</h1>      
            </div>
            <div class = "w-1/2 p-12 bg-gray-300 hover:bg-gray-500 rounded-lg mx-6 flex flex-col items-center justify-center">
                     <img src={Logo} className="h-16" alt="Cycle Logo"/>    
                    <h1 class=" text-base  title-font text-gray-900 ">All Ride</h1>         
            </div>
            </section>
            <h1 class="sm:text-3xl text-s  title-font  text-gray-900 font-bold">Story Section</h1>            
            <section>            
